  ...
  return (
    <div className="space-y-6 text-center">
      ...
      <div className="space-y-4">
        ...
        {/* TEXTO DE INSTRUÇÃO SOMENTE SE NÃO TIVER FOTO */}
      ...
      <div className="space-y-2 w-full">
        <Button className="w-full" onClick={() => setCurrentStep('fotoBauAberto')}>
          Voltar
        </Button>
        <Button className="w-full" onClick={() => setCurrentStep('temperatura')}>
          Próximo
        </Button>
      </div>
    </div>
